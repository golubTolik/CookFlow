      ...
      <div v-else>
        ...
        <section class="!mb-12">
          <div class="flex justify-between items-center !mb-4">
            <h2 class="text-2xl !font-bold text-gray-800">Лайкнутые рецепты</h2>
        ...
        <section>
            <div class="flex justify-between items-center !mb-4">
                <h2 class="text-2xl !font-bold text-gray-800">Избранные статьи</h2>
                <span class="bg-gray-200 text-gray-700 rounded-full px-3 py-1 text-sm">
  ...
  methods: {
    ...
    loadUserData() {
      ...
      if (storedUser) {
        ...
        // Добавляем поля для избранного, если их нет
